...
<head>
    <meta charset="UTF-8">
    <title>Small Business and It Consulting - TechSpot</title>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="about-text">
                        <div class="text">
                                <p><b>Detailed Website</b> - There is a huge competition on the web. Therefore, we work on the overall personality of your website including right selection of fonts and great design to enhance its functionality.</p>
                                <p><b>Well Aligned Structure</b> - We do not believe in stuffing the website with an eye-catching design. But, we offer clear design and navigation that seem compelling enough for visitors to stay on the page.</p>
                            <p><b>Distinct from Comeptitors</b> - We see the similar websites on the web, but our aim is to make you the winner by adding unique selling points in your website. Our designers do it with an amalgamation of good design & graphics.</p>
                                <p><b>Scope for Development</b> - A quality design always comes up with the scope of further improvements. It means to say that we offer you a website with strong aesthetic, which allows you to add both services and products.</p>
                        </div>
                    </div>
                </div>
            </div>
